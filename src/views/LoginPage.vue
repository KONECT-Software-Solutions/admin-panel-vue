            ...
            <div class="w-full bg-gray-700 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form @submit.prevent="login" class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div>
                            <label for="password" class="block mb-2 text-sm font-medium text-white-900 text-white">Password</label>
                        ...
                        <button id="signin" class="w-full inline-block text-white bg-gray-600 focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
                    </form>
                </div>
            </div>
        </div>
