      ...
      <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 mb-6">
        <div class="flex justify-between items-center mb-3">
          ...
          <label class="inline-flex items-center cursor-pointer">
            <input
              v-model="props.schedule.isWorkingHoursEnabled"
              type="checkbox"
              class="sr-only peer" />
            <div
      ...
      <div
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            ...
            <label
              :for="`toggle-${day.name}`"
              class="ml-2 p-1.5 text-sm font-medium text-gray-900"
              >{{ day.name }}</label
            >
          </div>
          <div
            ...
            <svg
              ...
              <path
                ...
                stroke-width="2"
                :d="
                  collapsedStates[index] ? 'M19 9l-7 7-7-7' : 'M19 15l-7-7-7 7'
                " />
            </svg>
          </div>
        </div>
        <div v-if="!collapsedStates[index]" class="mt-4">
          <div
            v-for="(slot, slotIndex) in day.intervals"
            :key="slotIndex"
            ...
            <div
              v-if="slotIndex === day.intervals.length - 1"
