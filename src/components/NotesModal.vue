<template>
    ...
    <div tabindex="-1" v-if="show" class="fixed inset-0 flex items-center justify-center z-50 w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            ...
            <div class="relative  bg-white rounded-lg shadow">
                ...
                <div class="grid gap-4 mb-4 p-4 pb-6 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <p type="text" name="title" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Blog yazısı başlığını girin" required="">{{ customerNotes }}</p>
                    </div>
                </div>
            </div>
        </div>
