      ...
      <div class="relative bg-white rounded-lg shadow">
        ...
        <div class="px-6 py-4 w-full mx-auto bg-white rounded-xl space-y-4">
          ...
          <div>
            ...
            <div v-if="!isMeetingSet && !isMeetingDeclined && !isDeclining"
            ...
            <div v-if="!isMeetingSet && !isMeetingDeclined && !isDeclining"
              ...
              <button @click="isDeclining = true" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md">
                Hayır
              </button>
            </div>

            <!-- Cancellation reason area -->
...
const isMeetingDeclined = ref(false);
